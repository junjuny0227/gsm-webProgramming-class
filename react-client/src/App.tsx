              ...
              <div className="text-center py-16">
                <div className="bg-white rounded-2xl p-8 shadow-sm border border-slate-200 max-w-lg mx-auto">
                  ...
                  <div className="flex flex-wrap justify-center gap-2 mt-6">
                    <span className="px-4 py-2 bg-slate-100 hover:bg-slate-200 rounded-full text-sm text-slate-700 cursor-pointer transition-colors duration-200">
                      Check-in Times
                    </span>
                    <span className="px-4 py-2 bg-slate-100 hover:bg-slate-200 rounded-full text-sm text-slate-700 cursor-pointer transition-colors duration-200">
                      Room Service
            ...
            {isLoading && (
              <div className="flex justify-start mb-4">
                <div className="flex items-start space-x-3 max-w-[75%]">
                  ...
                  <div className="bg-white text-slate-800 border border-slate-200 rounded-2xl rounded-bl-sm shadow-sm px-5 py-3">
